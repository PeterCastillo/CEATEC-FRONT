...
interface IRolesEditableForm {
  rol: IRol;
  setRol: (state: IRol) => void;
}
export const RolesEditableForm: FC<IRolesEditableForm> = ({
  rol,
  setRol
}) => {
  ...
  const handleModuleChange = (descripcion: string) => {
    const validaro = rol.modulos.find(
      (item) => item.descripcion == descripcion
    );
    if (validaro) {
      return setRol({
        ...rol,
        modulos: rol.modulos.map((item) =>
    ...
    setRol({
      ...rol,
      modulos: [...rol.modulos, { descripcion: descripcion, estado: true }],
    });
  };
          ...
          <div className={style.input_container}>
            ...
            <div>
              <input
                ...
                checked={
                  rol.modulos.find((item) => item.descripcion == "Salir")
                    ?.estado ?? false
                }
              />
          ...
          <div className={style.input_container}>
            ...
            <div>
              <input
                ...
                checked={
                  rol.modulos.find((item) => item.descripcion == "Gestion")
                    ?.estado ?? false
                }
              />
            ...
            <div>
              <input
                ...
                checked={
                  rol.modulos.find((item) => item.descripcion == "Cobranzas")
                    ?.estado ?? false
                }
              />
            ...
            <div>
              <input
                ...
                checked={
                  rol.modulos.find((item) => item.descripcion == "Mesas")
                    ?.estado ?? false
                }
              />
