...
import style from "@/app/comercial/reportes/listado-situacion-documentos/page.module.scss";

interface IHistoricoDeDocumentos {}
interface IProvee {
  prove: string;
}
const proveedores = [
...
export const HistoricoDeDocumentos: FC<IHistoricoDeDocumentos> = () => {
      ...
      <div className={style.content}>
        <div className={style.form}>
          ...
          <div className={style.separator}>
            ...
            <span className={style.subtitle}>PERIODO</span>
            <div className={style.line}></div>
          </div>
          <div className={style.input_group}>
            <div>
