...
import style from "@/app/comercial/reportes/listado-egreso-caja/page.module.scss";

interface IListadoEgresoCaja {}
interface IProvee {
  prove: string;
}
const proveedores = [
...
export const ListadoEgresoCaja: FC<
  IListadoEgresoCaja
> = () => {
      ...
      <div className={style.content}>
        <div className={style.form}>
          ...
          <div className={style.separator}>
            ...
            <span className={style.subtitle}>PERIODO GASTO</span>
            <div className={style.line}></div>
          </div>
          <div className={style.input_group}>
            <div>
