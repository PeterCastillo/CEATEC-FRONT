...
import style from "@/app/comercial/reportes/listado-ingreso-efectivo-caja/page.module.scss";

interface IListadoIngresoEfectivoCaja {}
interface IProvee {
  prove: string;
}
const proveedores = [
...
export const ListadoIngresoEfectivoCaja: FC<
  IListadoIngresoEfectivoCaja
> = () => {
      ...
      <div className={style.content}>
        <div className={style.form}>
          ...
          <div className={style.colum_radio}>
            <label htmlFor="">Ingreso a caja por:</label>
            <div className={style.content_radios}>
              ...
              <div>
                <input autoComplete="off" type="radio" />
                <label htmlFor="">Cobranza</label>
              </div>
              <div>
                <input autoComplete="off" type="radio" />
                <label htmlFor="">Ambos</label>
              </div>
            </div>
          </div>
          ...
          <div className={style.separator}>
            ...
            <span className={style.subtitle}>PERIODO DE COBRANZA</span>
            <div className={style.line}></div>
          </div>
          <div className={style.input_group}>
            <div>
