...
import style from "@/app/comercial/reportes/listado-de-cliente/page.module.scss";

interface IListadoDeCliente {}
interface IArti {
  art: string;
}
const articulos = [
...
export const ListadoDeCliente: FC<IListadoDeCliente> = () => {
