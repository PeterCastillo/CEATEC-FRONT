...
import style from "@/app/comercial/reportes/listado-por-situacion/page.module.scss";

interface IListadoPorSituacion {}
interface IProvee {
  prove: string;
}
const proveedores = [
...
export const ListadoPorSituacion: FC<IListadoPorSituacion> = () => {
