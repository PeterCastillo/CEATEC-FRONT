...
import { HistoricoDeDocumentos } from "@/components/comercial/reportes/listado-situacion-documentos/HistoricoDeDocumentos";
    ...
    <>
      <div className={styles.header}>
        <div className={styles.head}>
          <span className={styles.title}>Historico de documento</span>
          <button className={styles.create} onClick={handleCreateMarca}>
            <FaPlus /> GUARDAR
          </button>
        </div>
        <div className={styles.foot}>
          <button className={styles.active}>Historico de documento</button>
        </div>
      </div>
