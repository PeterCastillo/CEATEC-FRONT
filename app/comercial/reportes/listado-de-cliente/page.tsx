"use client";
import { ListadoDeCliente } from "@/components/comercial/reportes/listado-de-cliente/ListadoClientes";
    ...
    <>
      <div className={styles.header}>
        <div className={styles.head}>
          <span className={styles.title}>Listado de Clientes</span>
          <button className={styles.create} onClick={handleCreateMarca}>
            <FaPlus /> GUARDAR
          </button>
        </div>
        <div className={styles.foot}>
          <button className={styles.active}>Listado de Clientes</button>
        </div>
      </div>
