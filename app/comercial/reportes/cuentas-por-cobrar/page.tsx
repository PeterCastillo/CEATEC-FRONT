"use client";
import { CuentasPorCobrar } from "@/components/comercial/reportes/cuentas-por-cobrar/CuentasPorCobrar";
    ...
    <>
      <div className={styles.header}>
        <div className={styles.head}>
          <span className={styles.title}>Cuentas por Cobrar</span>
          <button className={styles.create} onClick={handleCreateMarca}>
            <FaPlus /> GUARDAR
          </button>
        </div>
        <div className={styles.foot}>
          <button className={styles.active}>Cuentas por Cobrar</button>
        </div>
      </div>
